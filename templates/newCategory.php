...
<head>
    ...
    <link rel="stylesheet" href="/wp-content/themes/joq/assets/css/joq-design-system.css?v=3.0" type="text/css" />
...
<body>
    ...
    <!-- Hover Menu -->
    <div class="hovermenu pc-only category-tpl <?php echo $categorySlug ?>-border-color">
        <div class="container">
    ...
    <div class="container-wrapper">
        <div class="container padding-mobile category-body">
            ...
            <div class="home-category-wrapper">
                ...
                <div class="home-category-title category-tpl">
                ...
                <div class="load-more-category-wrapper">
	                <div id="load-more-art" class="load-more-home-button">
	                    Më shumë
	                </div>
	                <script type="text/javascript">
	                	if ($(window).width() <= 600) {
            ...
            <div class="category-right-block" style="margin-top: 75px;">
                <!-- Category Top News -->
        ...
        <div class="container footer">
            ...
            <div class="footer-dergo-materialin">
                <div class="footer-dergo-materialin-button">
                    <a href="mailto:info@joqalbania.com">Dërgo materialin tënd këtu</a>
