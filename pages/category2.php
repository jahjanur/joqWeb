...
<body>
            ...
            <div class="header-content">
                ...
                <div class="header-logo">
                    <a href="/" title="JOQ Albania">
                        <img src="https://static.joq-albania.com/assets/images/joq-final2.png" alt="JoqAlbania logo">
                        <div class="pc-only">
                            Albania
                        </div>
                    </a>
    ...
    <!-- Hover Menu -->
    <div class="hovermenu pc-only category-tpl">
        <div class="container">
        ...
        <div class="container padding-mobile category-body">
            ...
            <div class="category-right-block">
                <div class="banner-wrapper">
                    <img src="https://tpc.googlesyndication.com/simgad/14563598046973698780" border="0" width="300" height="250">
                </div>
                <!-- Category Top News -->
    ...
    <script src="https://static.joq-albania.com/assets/js/bannersys.js" type="text/javascript"></script>
...
$nameANDfolder = 'kategori/sport2.html';
