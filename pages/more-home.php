...
while( $featuredPosts->have_posts() ): $featuredPosts->the_post();
    ...
    $featuredObj->time_ago = joq_time_ago();
    $featuredObj->excerpt = wp_trim_words( wp_strip_all_tags( get_the_content() ), 26, '...' );
    $featuredObj->read_time = joq_read_time();
...
foreach ($topPosts as $p) :
    ...
    $topObj->time_ago = joq_time_ago( $p );
