...
$(document).ready(function () {
    ...
    if (typeof isNews != 'undefined' && isNews) {
        ...
        if (isMobile) {
            ...
            try {
                postscribe('#joq-banner-mob', '<script src="//ads.projectagoraservices.com/?id=6683" type="text/javascript"></script>');
            } catch (e) {}

            try {
                postscribe('#mob-footer-300x250', '<script src="//ads.projectagoraservices.com/?id=6685" type="text/javascript"></script>');
            } catch (e) {}
            ...
            try {
                ...
                if (breakLines.length > 2) {
                    ...
                    // Albawings
                    //$('.itemIntroText').children(':eq(1)').after('<div id="albawings_inside_news" class="mobile_only" style="margin: -10px auto 10px;"></div>');
                    //postscribe('#albawings_inside_news', '');

                    //TiranaBank
                    /* $('.itemIntroText').children(':eq(3)').after('<div id="tirbank_inside_news" class="mobile_only" style="margin: -10px auto 10px;"></div>');
            ...
            $.post("https://dynamic-php.abingmedia.com/country2.php", function (data) {
                ...
                if (rc_country != 'AL' && rc_country != '') {
                    ...
                    if (full_url.toLowerCase().indexOf("joq-albania.com") >= 0) {
                        ...
                        try {
                            postscribe('#rcjsload_c1f2ce', '<script src="//ads.projectagoraservices.com/?id=6689" type="text/javascript"></script>');
                        } catch (e) {
                    ...
                    // postscribe('#remove-fcb', '<script src="//ads.projectagoraservices.com/?id=6687" type="text/javascript"></script>');
            ...
            $.post("https://dynamic-php.abingmedia.com/country2.php", function (data) {
                ...
                if (rc_country != 'AL' && rc_country != '') {
                    ...
                    try {
                        ...
                        //second banner after gallery revcontent
                        postscribe('#pc-under-news', '<div id="M513484ScriptRootC1101560"></div><script src="https://jsc.mgid.com/j/o/joq-albania.com.1101560.js" async><\/script>');
